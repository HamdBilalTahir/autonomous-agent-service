...
export default function Home() {
  ...
  return (
    <main className="h-screen overflow-hidden flex flex-col items-center px-8 pt-6 pb-6">
      <div
        className={`w-full flex flex-col h-full transition-all duration-500 ${selectedBranch ? "max-w-7xl" : "max-w-5xl"}`}
      >
        {selectedBranch ? (
          ...
          <header className="text-center space-y-4 py-8 relative flex-shrink-0">
            <div className="inline-flex items-center justify-center p-3 bg-primary-mist/50 rounded-2xl mb-2 backdrop-blur-sm">
              ...
              <span className="text-primary-dark font-medium tracking-wide text-sm uppercase">
                AI-Powered Workflow
              </span>
            </div>
            ...
            <p className="text-xl text-primary/80 max-w-2xl mx-auto font-light leading-relaxed">
              Transform your ideas into comprehensive Jira user stories with
              intelligent automation and precision.
            </p>
            <a
              href="/monitor"
            ...
            <div className="w-full card shadow-[0_8px_30px_rgba(73,34,91,0.12)] border-none ring-1 ring-primary/5">
              ...
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-3 mb-8">
                  <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#6E3482] text-white text-sm font-bold">
                    1
                  </span>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-2.5">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm font-semibold text-slate-800 leading-tight mt-0.5 truncate">
                          {selectedRepo?.name}
                        </p>
                    ...
                    <div className="flex items-start gap-2.5">
                      ...
                      <div className="min-w-0">
                        ...
                        <code className="text-sm font-mono text-slate-800 leading-tight mt-0.5 block truncate">
                          {selectedBranch}
                        </code>
                      </div>
                    </div>
